...
class Clash(commands.Cog):
    ...
    async def lightning(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Lightning_Spell'))
    ...
    async def healing(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Healing_Spell'))
    ...
    async def rage(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Rage_Spell'))
    ...
    async def jump(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Jump_Spell'))
    ...
    async def freeze(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Freeze_Spell'))
    ...
    async def clone(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Clone_Spell'))
    ...
    async def invisibility(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Invisibility_Spell'))
    ...
    async def poison(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Poison_Spell'))
    ...
    async def earthquake(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Earthquake_Spell'))
    ...
    async def haste(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Haste_Spell'))
    ...
    async def skeleton(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Skeleton_Spell'))
    ...
    async def bat(self, ctx):
        ...
        await ctx.send(embed=self.embed(self.data['home']['spells'][name]["img"], self.title(name), 'https://clashofclans.fandom.com/wiki/Bat_Spell'))
